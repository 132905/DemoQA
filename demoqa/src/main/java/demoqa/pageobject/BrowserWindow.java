...
//	private WebElement newWindowMsgBtn; 
	...
	public void newTab() throws InterruptedException {
		...
		System.out.println("newTab Handle: "+originalWindowHandle);
		commonUtils.scrollDown(driver);
		Thread.sleep(500);
...
//                Document doc = (Document) Jsoup.parse(newTabContent);
//                StringBuilder textContentBuilder = new StringBuilder();
//                traverseElements(((org.jsoup.nodes.Document) doc).body(), textContentBuilder);
//                String textContent = textContentBuilder.toString();
                WebElement body = driver.findElement(By.xpath("//h1[@id=\"sampleHeading\"]"));
//                System.out.println("New window title: " + newWindowTitle);
                System.out.println("Content of new tab: " + body.getText());
                driver.close();
                break;
            }
        }
	...
	public void newWindow() throws InterruptedException {
		String originalWindowHandle = driver.getWindowHandle();
		System.out.println("newWindow Handle: "+originalWindowHandle);
		commonUtils.scrollDown(driver);
		Thread.sleep(500);
...
//                System.out.println("Content of new window: " + newTabContent);
                WebElement body = driver.findElement(By.xpath("//h1[@id=\"sampleHeading\"]"));
//              System.out.println("New window title: " + newWindowTitle);
              System.out.println("Content of new window: " + body.getText());
                driver.close();
                break;
            }
        }
	...
	public void newWindowMsg() throws InterruptedException {
		String originalWindowHandle = driver.getWindowHandle();
		System.out.println("newWindowMsg Handle: "+originalWindowHandle);
		commonUtils.scrollDown(driver);
		Thread.sleep(500);
...
//		newWindowMsgBtn.click();
		((JavascriptExecutor) driver).executeScript("arguments[0].click();", newWindowMsgBtn);
		Set<String> windowHandles = driver.getWindowHandles();
		for (String windowHandle : windowHandles) {
            if (!windowHandle.equals(originalWindowHandle)) {
                driver.switchTo().window(windowHandle);
                Thread.sleep(2000);
              System.out.println("New msg window was opened.");
                driver.close();
                break;
            }
        }
